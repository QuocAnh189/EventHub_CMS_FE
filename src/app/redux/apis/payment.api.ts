...
//enum
import { EPaymentStatus } from '@app/constant/enum.constant'

//payload-type
import { IParamsEvent } from '@shared/interfaces/event/payload'
import { CheckoutPayload, UpdateOrderPayload } from '@shared/interfaces/payment/payload'

//interface
import { ApiListResponse, IListData } from '@shared/interfaces/common'
import { IPayment, IPaymentMethod } from '@shared/interfaces/payment/model'
